...
// LocationDao is the data access object for table xf_location.
...
// LocationColumns defines and stores column names for table xf_location.
...
// locationColumns holds the columns for table xf_location.
