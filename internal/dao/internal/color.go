...
// ColorDao is the data access object for table xf_color.
...
// ColorColumns defines and stores column names for table xf_color.
...
// colorColumns holds the columns for table xf_color.
