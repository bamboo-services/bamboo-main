...
// SponsorRecordAddReq 添加赞助记录请求
type SponsorRecordAddReq struct {
...
// SponsorRecordUpdateReq 更新赞助记录请求
type SponsorRecordUpdateReq struct {
...
// SponsorRecordPageReq 分页查询请求(后台)
type SponsorRecordPageReq struct {
...
// SponsorRecordPublicPageReq 公开分页查询请求(前台)
type SponsorRecordPublicPageReq struct {
	Page      int     `form:"page" binding:"omitempty,min=1" example:"1"`                                           // 页码,默认1
