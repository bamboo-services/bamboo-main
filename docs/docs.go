...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiSponsor.RecordAdminPageResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/admin/sponsors/records/{id}/status": {
            "put": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "审核赞助记录请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiSponsor.SponsorStatusRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiAuth.UserListResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiAuth.UserStatusRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/apiLink.FriendFailedResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/api/v1/sponsors/apply": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "赞助展示申请请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiSponsor.SponsorApplyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/user/sponsors": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "赞助状态 0:待审核 1:已通过 2:已拒绝",
                        "name": "sponsor_status",
                        "in": "query"
                    }
                ],
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apiSponsor.SponsorUserUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "apiInfo.BuiltinInvalidGroupUpdateRequest": {
            ...
            "properties": {
                "description": {
                    "description": "分组描述（空串清空）",
                    "type": "string",
                    "maxLength": 500,
                    "example": "已失效友链，站点不可访问"
                },
                "name": {
                    "description": "分组名称",
                    "type": "string",
        ...
        "apiLink.FriendFailedResponse": {
            "type": "object",
            "properties": {
                "group": {
                    "description": "内置「已失效」分组信息",
                    "allOf": [
                        {
                            "$ref": "#/definitions/entity.LinkGroup"
                        }
        ...
        "apiSponsor.RecordAdminPageResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "description": "数据列表",
        ...
        "apiSponsor.SponsorApplyRequest": {
            "type": "object",
            "required": [
                "amount",
                "email",
        ...
        "apiSponsor.SponsorStatusRequest": {
            "type": "object",
            "required": [
                "sponsor_status"
            ],
            "properties": {
                "sponsor_review_remark": {
        ...
        "apiSponsor.SponsorUserUpdateRequest": {
            "type": "object",
            "properties": {
                "apply_remark": {
                    "description": "申请者备注",
